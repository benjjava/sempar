...
Possibly a diagonal instead of square matrix
...
"""
    def __init__(self, device, in_size, num_scores_per_arc=1, use_bias=False, diag=False):
    ...
    def forward(self, Hh, Hd):
        ...
        #if diagonal biaffine, first hadamart product then matric product
        #because each label got a vector, i.e (1, n) matrix, not square
        else:
            S = Hh * self.U @ Hd.transpose(-1, -2)
